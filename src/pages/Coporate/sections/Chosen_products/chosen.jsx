...
function ChosenProducts() {
	return (
		<section className="w-full flex justify-center flex-col items-center py-[6rem]">
			<div className="w-[85%] flex gap-12 justify-center items-center">
				<div className="w-full flex flex-col justify-center w-[50%] lg:w-[100%] text-left">
					<h3 className="text-[54px] font-acumin font-bold">Professional Videos for <br/>Brand Aware Clients.</h3>
					<p className="text-[22px] font-normal font-acumin">Intervjuer, Employer Branding, demofilmer. Xpand<br/> 
